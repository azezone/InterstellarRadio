    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_110 = (_node_2826*(node_574.a - 0.5)*mul(tangentTransform, viewDirection).xy + node_35);
