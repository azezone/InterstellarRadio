...
public static class SOVRMathUtils
{
    ...
    public static void Normalize(ref Quaternion q)
    {
        ...
        SOVRDebugUtils.Assert(mag > FltSmallestNonDenormal);
    ...
    public static Quaternion RotationBetweenTwoVectors(Vector3 from, Vector3 to)
    {
        /*
                ...
                if ( dot > 0.9999f )
                {
                    SOVRDebugUtils.Assert( dot <= 0.9999f );
                ...
                SOVRDebugUtils.Assert( axis.magnitude > 0.0001f );
        ...
        */
        ...
        SOVRDebugUtils.Assert(q.w > 1e-18f);
        Normalize(ref q);
        return q;
    }
    ...
    {
        SOVRDebugUtils.Assert(QuaternionIsNormalized(a, 0.001f));
        SOVRDebugUtils.Assert(QuaternionIsNormalized(b, 0.001f));
    ...
    public static bool Clamp(ref Quaternion q, float cosineOfClampAngle)
    {
        ...
        SOVRDebugUtils.Assert(s > SOVRMathUtils.FltSmallestNonDenormal);
