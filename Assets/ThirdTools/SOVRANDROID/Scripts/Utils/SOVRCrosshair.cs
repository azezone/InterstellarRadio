...
/// <summary>
/// SOVRCrosshair is a component that adds a stereoscoppic cross-hair into a scene.
/// </summary>
public class SOVRCrosshair
{
    #region Variables
    public Texture ImageCrosshair = null;

    public SOVRCameraRig CameraController = null;
    public SOVRPlayerController PlayerController = null;
    ...
    /// <summary>
    /// Sets the SOVR camera controller.
    /// </summary>
    /// <param name="cameraController">Camera controller.</param>
    public void SetSOVRCameraController(ref SOVRCameraRig cameraController)
    {
    ...
    /// <summary>
    /// Sets the SOVR player controller.
    /// </summary>
    /// <param name="playerController">Player controller.</param>
    public void SetSOVRPlayerController(ref SOVRPlayerController playerController)
    {
